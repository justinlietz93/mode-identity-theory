...
**Related:** [First Eigenvalue](../../framework/pillars/first-eigenvalue.md), [Black Double Zero's](../../cosmos/files/black-hole.md), [Oort Cloud project](oort-cloud-project.md), [SPARC phase field notes](sparc-phase-field.md).
