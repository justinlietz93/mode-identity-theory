...
|---|---|---|---|---|
| $R_1$ | 2 | 0 | 1 | $\nu_1$, $\nu_3$ (singlet via $\rho\otimes\sigma$) |
| $R_3$ | 3 | 1 | 1 | (dead zone) |
| $R_6$ | 4 | 2 | 1 | (dead zone) |
| $R_7$ | 5 | 1 | 2 | $e$ |
| $R_8$ | 6 | 2 | 2 | $u$, $d$, $\mu/s$ |
