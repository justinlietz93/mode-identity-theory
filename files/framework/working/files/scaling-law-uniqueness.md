...
| 3 | Discrete 120-domain: \|2I\| = 120 | Given the S³/2I quotient, \|2I\| = 120 (THEOREM); the quotient is selected, not free: 2I is the terminal closed exceptional subgroup and the unique *perfect* subgroup of SU(2), which is what yields the 9× Galois mass gap ([coexact-gap.md](../../bedrock/coexact-gap.md)) | Continuous sampling rules. Phase positions are quantized to multiples of 1/120. |
