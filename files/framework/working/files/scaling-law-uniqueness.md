...
*Carried (deferred): the 2I selection above reads as a physical necessity (the fermion generations need the 9× Galois gap) plus coexact uniqueness (2I is the only perfect subgroup of SU(2)). Turning that into a formal physical-selection theorem (requirement ⇒ unique Γ) is open and not attempted here.*
