...
| 6 | a₀/(cH₀) pair (13,34) | 7,021 phase-position pairs, ±1% of the observed ratio | **chosen, audited (provisional)** — exceptional within the Fibonacci-pair subclass (24 pairs = 0.34% within 1%; (13,34) is 1 of the 6 Fibonacci pairs); denominator not shown pre-target; a₀ and H₀ are inputs, the ratio a retrodiction | a₀/(cH₀) |
