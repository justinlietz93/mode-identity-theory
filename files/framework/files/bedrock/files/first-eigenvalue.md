...
**Sector-bottom divergence.** The sector bottoms tend to $+\infty$, which is what gives each realization of Definition 3.4 compact resolvent and discrete spectrum (Proposition 3.5). In the sector with transverse Neumann eigenvalue $\mu$ the indicial exponent is $\alpha = \sqrt{\mu}\,R$, and the ground-state transforms of §6.1 and §6.2 identify the nonconstant sector bottom as $\alpha(\alpha+1)/R^2$, while the constant sector is bounded below by $\lambda_b(\delta_0)$ (Proposition 4.4). The transverse Neumann eigenvalues $\mu_k^{\mathrm{e}} = (k\pi/W)^2$ and $\mu_j^{\mathrm{o}} = ((2j+1)\pi/(2W))^2$ increase without bound in the sector index, so $\alpha \to \infty$ and the bottoms $\alpha(\alpha+1)/R^2 \to +\infty$.
