...
|---|---|---|
| [$s_0$](../working/files/temporal-budget.md) | $< 0.19$ (95% CL) | Observer's current phase on the standing wave. $\Omega_m = 1 - \Omega_\Lambda = 0.315$ is output of the temporal budget. |
