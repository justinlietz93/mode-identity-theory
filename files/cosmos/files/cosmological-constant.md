...
Gaussian curvature $K_G = 1/R^2$. Scalar curvature $R_\Sigma = 2K_G = 2/R^2$. The factor $\cos(y/R)$ vanishes at $y = \pi R/2$: a coordinate pole at the midpoint of the band, smooth on the surface. Full treatment in [ground-eigenvalue](../cosmos/files/ground-eigenvalue.md)
