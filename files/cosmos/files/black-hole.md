...
The [Sector A eigenvalue problem](../../framework/files/bedrock/first-eigenvalue.md) gives the first positive eigenfunction and the metric coefficient on the totally geodesic Möbius band in $S^3$:
