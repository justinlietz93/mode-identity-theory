...
Topology becomes structure and this repository lays out the results. The universe admits a standing wave and matter becomes a sample. Time ticks in phase and doesn't run in the background. The observer is part of the realization, not external to it.
